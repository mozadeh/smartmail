...
public class MailSender extends javax.mail.Authenticator { 
  ...
  public MailSender() { 
    _host = "mail.mailivy.com"; // default smtp server 
  ...
  public MailSender(String user, String pass, String host) { 
	    this(); 
  ...
  public MailSender(String user, String pass, String port, String host) { 
	    this(); 
	    _host=host;
	    _port=port;
	    _user = user; 
